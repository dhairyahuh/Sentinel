...
children.push(
  ...
  new Paragraph({
    ...
    spacing: { after: 600 },
    children: [
      new TextRun({ text: 'Sentinel · Financial Crime Pattern Intelligence', size: 21, color: MUTED, font: 'Calibri' }),
    ],
  }),
  table(
    [{ h: 'Artifact', w: 34 }, { h: 'Where it is', w: 66 }],
    [
      ['**Code repository', 'GitHub — all pillars, organised, documented, reproducible'],
      ['**Solution walkthrough', 'This document'],
      ['**Working prototype', 'Sentinel console with offline demo mode. Also runs locally against the API with `docker compose up`.'],
...
children.push(
  ...
  table(
    ...
    [
      ['**The prototype (client-side demo)', 'Sentinel console'],
...
const doc = new Document({
  creator: 'Sentinel',
  title: 'Sentinel — Financial Crime Pattern Intelligence Walkthrough',
